...
(New-Object System.Net.WebClient).DownloadFile("https://raw.githubusercontent.com/ahmadzahoory/az305/master/lab-305-02-code-srv2.zip", (Get-Location).Path + "\lab-305-02-code-srv2.zip")
$zipfile = $shell_app.Namespace((Get-Location).Path + "\lab-305-02-code-srv2.zip")
