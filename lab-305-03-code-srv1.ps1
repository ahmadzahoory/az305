...
(New-Object System.Net.WebClient).DownloadFile("https://raw.githubusercontent.com/ahmadzahoory/az305/master/lab-305-03-code-srv1.zip", (Get-Location).Path + "\lab-305-03-code-srv1.zip")
$zipfile = $shell_app.Namespace((Get-Location).Path + "\lab-305-03-code-srv1.zip")
